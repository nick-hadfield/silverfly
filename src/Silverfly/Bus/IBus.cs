...
namespace Silverfly
{
    ...
    public interface IBus
    {
        ...
        void Publish<TNotification>(object sender, TNotification notification) where TNotification : class;
        ...
        void Subscribe<TNotification>(Action<object, TNotification> handler) where TNotification : class;
        ...
        void Unsubscribe<TNotification>(Action<object, TNotification> handler) where TNotification : class;
    }
}
